...
int main(int argc, char *argv[])
{
    ...
    for(;;){
        ...
        /// laplacian operation
        Laplacian( image_gray, dest, ddepth, kernel_size, scale, delta, BORDER_DEFAULT ); /// explorar os parametros e comentar os resultados
        convertScaleAbs( dest, abs_dst ); // converte para a imagem abs_dst com 8 bits
