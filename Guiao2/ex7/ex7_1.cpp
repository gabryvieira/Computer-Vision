...
int main( int argc, char** argv )
{
  ...
  // src_test2 = imread( argv[4], 1 );
  // src_test2 = imread( argv[5], 1 );
  ...
  // calcHist( &hsv_test3, 1, channels, Mat(), hist_test2, 2, histSize, ranges, true, false );
  // normalize( hist_test3, hist_test3, 0, 1, NORM_MINMAX, -1, Mat() );

  // calcHist( &hsv_test4, 1, channels, Mat(), hist_test2, 2, histSize, ranges, true, false );
  // normalize( hist_test4, hist_test3, 0, 1, NORM_MINMAX, -1, Mat() );
